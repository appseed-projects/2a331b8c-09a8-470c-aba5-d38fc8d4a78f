...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-19 11:26`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/2a331b8c-09a8-470c-aba5-d38fc8d4a78f.git
$ cd 2a331b8c-09a8-470c-aba5-d38fc8d4a78f
```
